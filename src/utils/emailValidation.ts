...
export const LOWERCASE_EMAIL_ERROR = 'Email address must contain only lowercase letters.';
export const INVALID_EMAIL_FORMAT_ERROR = 'Please enter a valid email address format.';
export const DOMAIN_EMAIL_ERROR = 'Only official @kgkite.ac.in email addresses are allowed.';
